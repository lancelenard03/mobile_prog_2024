...
// The spread operator is a new addition to the set of operators in JavaScript ES6. It takes in an iterable (e.g an  array) and exapnds it into individual elements. The spread operator is used to copy an array, merge arrays, add elements to an array, and add properties to an object.
...
// The spread operator is noit only used for arrays, it can also be used for objects.
// Example 4
// Copying an object
